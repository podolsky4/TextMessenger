...
render() {
    return (
        <Switch>
            ...
            <Route exact path='/dialogs/:dialogId' render={(props) => <Header pageTitle={'Your Dialogs'} {...props} />}/>
            <Route exact path='/post/:postId' render={(props) => <Header pageTitle={'Post'} {...props} />}/>
            <Route exact path='/dialogs' render={(props) => <Header pageTitle={'Your Dialogs'} {...props} />}/>
