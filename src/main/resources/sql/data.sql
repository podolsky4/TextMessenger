-- Add several users
INSERT INTO `user` (`login`, `email`, `password`, `first_name`, `last_name`, `profile_photo`, `created_at`) VALUES ('test', 'test@gmail.com', 'test', 'test', 'test', 'https://cdn.pixabay.com/photo/2016/08/08/09/17/avatar-1577909__340.png' ,'2008-03-01 17:04:33');
