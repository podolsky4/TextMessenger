-- Add several users
INSERT INTO `user` (`login`, `email`, `password`, `first_name`, `last_name`, `profile_photo`, `created_at`) VALUES ('test', 'test@gmail.com', '$2a$10$Nxv31bE4lCSQtJoGy.x3SOlzjUqnxLBvGHqII69caX0LQf53tpCy6', 'test', 'test', 'https://cdn.pixabay.com/photo/2016/08/08/09/17/avatar-1577909__340.png' ,'2008-03-01 17:05:33');
...
INSERT INTO `post` (`content`, `created_at`, `last_update`, `user_id`,`img_url`,`img_key`) VALUES ('I was recently diagnosed with testicular cancer. Yes, the dreaded c word. It’s probably not what you are thinking. I don’t look at this health issue as an anchor. I look at this as an opportunity for growth.', '2016-07-07 09:04:10', '2016-09-17 14:16:29', 5,'https://my-text-messages.s3.us-east-2.amazonaws.com/postImage/9c15b9af-960d-4819-9732-6e08bac47680.jpeg','postImage/9c15b9af-960d-4819-9732-6e08bac47680.jpeg');
