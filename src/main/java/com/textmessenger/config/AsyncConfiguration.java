...
public class AsyncConfiguration implements AsyncConfigurer {
  ...
  private final AsyncApplicationProperties applicationProperties;

  public AsyncConfiguration(final AsyncApplicationProperties applicationProperties) {
  ...
  private Executor newTaskExecutor(final String taskExecutorNamePrefix) {
    final AsyncApplicationProperties.Async asyncProperties = applicationProperties.getAsync();
